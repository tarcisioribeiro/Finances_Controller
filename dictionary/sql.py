...
future_accounts_revenue_query: str = """
            ...
            WHERE
                receitas.recebido = 'N'
                    ...
                    AND usuarios.senha = '{}'
            GROUP BY conta
            ORDER BY conta ASC;""".format(logged_user, logged_user_password)
...
name_query: str = ("SELECT nome FROM usuarios WHERE login = '{}' AND senha = '{}'".format(
    logged_user, logged_user_password))
...
owner_active_cards_query = """
    ...
    WHERE
        usuarios.login = '{}'
            AND usuarios.senha = '{}'
            AND cartao_credito.inativo = 'N';""".format(logged_user, logged_user_password)
...
debtors_query: str = """
    ...
    WHERE
        ...
        AND usuarios.login = '{}'
        AND usuarios.senha = '{}'
    GROUP BY emprestimos.devedor""".format(logged_user, logged_user_password)
...
not_payed_loans_query = '''
    ...
    WHERE
        usuarios.login = '{}'
        AND usuarios.senha = '{}'
        AND pago = 'N';'''.format(logged_user, logged_user_password)
